        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-blue-100/90 mb-8 max-w-2xl mx-auto">
              Tell us your goals — we’ll propose a team composition and ramp‑up plan.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {/* Primary CTA — narrower, text white stays on hover */}
              <Button
                asChild
                size="lg"
                className="bg-white text-primary hover:bg-white/90 hover:underline w-full sm:w-[22rem] max-w-[22rem] rounded-xl"
              >
                <Link to="/contact">
                  Build Your Team
                  <ArrowRight className="ml-2 h-5 w-5" />
              ...
              {/* Secondary CTA — shorter, readable */}
              <Button
                asChild
                variant="outline"
                size="lg"
              ...
              >
                <Link to="/developers">View Profiles</Link>
              </Button>
            </div>
          </div>
        </div>
